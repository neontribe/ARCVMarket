        ...
        <main class="container fullwidth" id="privacy">
            ...
            <div class="content fullwidth">
                ...
                <section>
                  ...
                  <h1>Rosie – the Rose Voucher Recording System for Traders</h1>
                  ...
                  <p>Signing up for a Rosie account requires a user to provide certain basic information to set up &amp; operate the account.</p>
                  ...
                  <ul>
                      ...
                      <li>Prevention or detection of crime including the apprehension or prosecution of offenders;</li>
                      <li>Assessment or collection of tax duty;</li>
                      <li>Discharge of regulatory functions (includes health, safety and welfare of persons at work);</li>
                      <li>To prevent serious harm to a third party;</li>
                      <li>To protect the vital interests of the individual, this refers to life and death situations.</li>
                  </ul>
              ...
              <section>
                  ...
                  <p>These terms of use apply to your use of The Rose Voucher Recording System for Traders (hereby referred to as ‘Rosie’) which is owned and operated by Alexandra Rose Charity (referred to here as ARC or “we”) whose registered office is Suite 5B, The Oast House, 5 Mead Lane, Farnham, Surrey, GU9 7DY.</p>

                  <p>Please read these terms of use carefully because, by using Rosie, you acknowledge that you have read, understood, and agree to be bound by these Terms of Use, our Privacy Policy and that you will comply with all laws applicable to your use of Rosie.</p>

                  <p>We reserve the right to modify the Terms of Use at any time. You should therefore check the Terms of Use periodically for changes. By using Rosie after we post any changes, you agree to accept those changes, whether or not you have reviewed them.</p>

                  <p>If, at any time, you choose not to accept the Terms of Use, please do not use Rosie.</p>

                  <h3>Links</h3>

                  <p>The Terms of Use apply only to Rosie and not to any other sites/apps which Rosie hyperlinks to. We assume no responsibility whatsoever for websites/apps that Rosie either hyperlinks to or otherwise refers to. In particular, we do not assume any responsibility for any information or content on such sites (including but not limited to any views, advice, opinions, advertising, or recommendations). Nor do we assume any responsibility in connection with any product or service such sites may offer. Under no circumstances will ARC, its officers, employees, contractors or content providers be liable, directly or indirectly, for any loss or damage resulting from you accessing or using, or otherwise in connection with, any website/app either hyperlinked to or otherwise referred to on Rosie.</p>

                  <h3>Disclaimers</h3>

                  <p>While ARC takes reasonable steps to ensure the quality of content and information made available on Rosie in general, neither it nor its officers, employees, contractors or content providers assume any responsibility for the accuracy, correctness, relevance, completeness or currency of the information or other content on Rosie.</p>

                  <p>ARC does not warrant that any functions contained in Rosie will always be available or will be uninterrupted or error-free, or that content and materials on Rosie or the server that makes it available will be free of viruses or other harmful components. You should take appropriate precautions to ensure that any content you download is free of such viruses and other harmful content.</p>

                  <p>We control and operate Rosie from our offices in the United Kingdom. We do not represent that the content or other information provided on Rosie (including any advertising, promotion or any service) are appropriate, relevant or available for use outside the UK. The laws of The United Kingdom of Great Britain and Northern Ireland shall govern your use of Rosie and you hereby agree to submit to the exclusive jurisdiction of the UK courts.</p>
