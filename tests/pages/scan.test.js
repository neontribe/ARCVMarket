...
test('Correct error appears when I submit a duplicate voucher', async t => {
    ...
    expect(errorMessage).to.contain('It looks like this code has already been added, please double check and try again. If you are still unable to add the voucher code, don\'t worry - you will still receive payment if you send it in with your other vouchers.');
});
